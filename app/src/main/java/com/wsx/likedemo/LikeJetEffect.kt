...
import com.wsx.likedemo.leonids.ParticleSystem
import com.wsx.likedemo.leonids.ScaleModifier
import com.wsx.likedemo.utils.ApplicationUtils
import com.wsx.likedemo.utils.DeviceUtils
import com.wsx.likedemo.utils.ImageUtils
import java.util.*
...
//            likeNumView?.translationY = location[1].toFloat() - DeviceUtils.dp2px(view.context, 60f)
            //控制数字部分距离点赞图标的距离
            likeNumView?.translationY = location[1].toFloat() - DeviceUtils.dp2px(view.context, 140f)
        }
    }
